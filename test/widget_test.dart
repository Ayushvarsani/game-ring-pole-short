...
import 'package:color_short/models/bottle_model.dart';
...
void main() {
  group('BottleModel', () {
    ...
    test('solved bottle detection', () {
      final solved = BottleModel(id: 0, colors: [
        Colors.blue, Colors.blue, Colors.blue, Colors.blue,
      ]);
      expect(solved.isSolved, true);

      final notSolved = BottleModel(id: 1, colors: [
    ...
    test('topColorCount counts consecutive top colors', () {
      final bottle = BottleModel(id: 0, colors: [
        Colors.red, Colors.blue, Colors.blue, Colors.blue,
      ]);
